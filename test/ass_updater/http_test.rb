...
class AssUpdaterHTTPTest < Minitest::Test
  ...
  def test_http
    assert_instance_of Net::HTTP, @http.send(:_http,
                                             URI('http://example.com/foo')
                                            )
  end

  def test__get
    assert_instance_of Net::HTTP::Get, @http.send(:_get,
                                                  '',
                                                  '',
                                                  URI('http://example.com/foo')
                                                 )
